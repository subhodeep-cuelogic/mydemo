...
class ap_DevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd6_1' => 'get9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd61Service',
            'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_1' => 'getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e1Service',
            'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_2' => 'getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e2Service',
            'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_3' => 'getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e3Service',
    ...
    /**
     * Gets the '9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd6_1' service.
     *
     ...
     */
    protected function get9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd61Service()
    {
        return $this->services['9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd6_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the 'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e1Service()
    {
        return $this->services['a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e2Service()
    {
        return $this->services['a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getA8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e3Service()
    {
        return $this->services['a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/opt/lampp/htdocs/firstapp/app/cache/de_/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/opt/lampp/htdocs/firstapp/app/cache/de_/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/opt/lampp/htdocs/firstapp/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/opt/lampp/htdocs/firstapp/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_fa96403c65f015c223ffba2aeca1986892c54cc5afe7d055b7d4818fad079fbe');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_fa96403c65f015c223ffba2aeca1986892c54cc5afe7d055b7d4818fad079fbe');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_fa96403c65f015c223ffba2aeca1986892c54cc5afe7d055b7d4818fad079fbe');
        ...
        $d->setProxyDir('/opt/lampp/htdocs/firstapp/app/cache/de_/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/opt/lampp/htdocs/firstapp/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('9019dfd614f3ea1122c7e33e176fb593a9ad822d26a1e486dd2d0283ba2c9dd6_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/opt/lampp/htdocs/firstapp/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/opt/lampp/htdocs/firstapp/app/cache/de_/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/opt/lampp/htdocs/firstapp/app/cache/de_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/opt/lampp/htdocs/firstapp/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/opt/lampp/htdocs/firstapp/app/cache/de_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_1'), 1 => $this->get('a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_2'), 2 => $this->get('a8e46259764aa54d23928e266d27df301e3f8ce3ef58e977dfde43d65c5fea2e_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/opt/lampp/htdocs/firstapp/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/opt/lampp/htdocs/firstapp/app/cache/de_/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/opt/lampp/htdocs/firstapp/app/cache/de_/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/opt/lampp/htdocs/firstapp/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/opt/lampp/htdocs/firstapp/src/Cue/ComBundle/Resources/views', 'CueCom');
        $instance->addPath('/opt/lampp/htdocs/firstapp/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/opt/lampp/htdocs/firstapp/app/Resources/views');
        $instance->addPath('/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/opt/lampp/htdocs/firstapp/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/opt/lampp/htdocs/firstapp/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/opt/lampp/htdocs/firstapp/app/cache/de_/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/opt/lampp/htdocs/firstapp/app/cache/de_');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/opt/lampp/htdocs/firstapp/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/opt/lampp/htdocs/firstapp/app/cache/de_',
            'kernel.logs_dir' => '/opt/lampp/htdocs/firstapp/app/logs',
            'kernel.bundles' => array(
                ...
                'CueComBundle' => 'Cue\\ComBundle\\CueComBundle',
            ...
            'debug.container.dump' => '/opt/lampp/htdocs/firstapp/app/cache/de_/ap_DevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/opt/lampp/htdocs/firstapp/app/cache/de_/sessions',
            ...
            'profiler.storage.dsn' => 'file:/opt/lampp/htdocs/firstapp/app/cache/de_/profiler',
            ...
            'router.resource' => '/opt/lampp/htdocs/firstapp/app/cache/de_/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/opt/lampp/htdocs/firstapp/app/cache/de_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/opt/lampp/htdocs/firstapp/app/cache/de_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/opt/lampp/htdocs/firstapp/app/cache/de_/assetic',
            ...
            'assetic.read_from' => '/opt/lampp/htdocs/firstapp/app/../web',
            'assetic.write_to' => '/opt/lampp/htdocs/firstapp/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/firstapp/app/cache/de_/doctrine/orm/Proxies',
